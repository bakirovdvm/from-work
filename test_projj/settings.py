"""
Django settings for test_projj project.
...
SECRET_KEY = 'lm$ek*85m!sxyjz0j=y4&!z%b$9s6f9ja0wmnd)xx=8^%979by'
...
WSGI_APPLICATION = 'test_projj.wsgi.application'
